...
if __name__ =="__main__":
    ...
    pcd_path = f'/scratch/projects/fouheylab/dma9300/recon3d/data_point_clouds/{frame_id}'
    trans_path = '/scratch/projects/fouheylab/dma9300/recon3d/data/output_data/'
    target_id = '1246'
